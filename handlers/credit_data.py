...
PLATFORM_TABLE_FIELD = ['course_name', 'course_id', 'course_status', 'enroll_num', 'discussion_num', 'avg_score']

PLATFORM_TABLE_NAME= [u'序号', u'课程名称', u'课程id', u'课程状态', u'学生人数', u'讨论区发回帖数', u'学生平均分']
...
class CreditPlatformTable(CreditData):
    ...
    def get_query(self):
        ...
        query = self.es_query(index=settings.CREDIT_ES_INDEX, doc_type='course_plat_detail') \
                    ...
                    .source(['course_name', 'course_status', 'enroll_num', 'discussion_num','avg_score', 'course_id']) \
                    .sort(sort_argument) 
